    ...
    <section id="features" className="w-full py-12 md:py-24 lg:py-32 bg-white dark:bg-gray-800">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <FeatureCard
            icon={<Shield className="h-10 w-10 sm:h-12 sm:w-12 text-purple-600 dark:text-purple-400" />}
            title="Secure Transactions"
            description="All bookings are secured by Solana blockchain technology, ensuring unparalleled safety and transparency."
          />
          <FeatureCard
            icon={<Coins className="h-10 w-10 sm:h-12 sm:w-12 text-indigo-600 dark:text-indigo-400" />}
            title="Crypto Payments"
            description="Pay for your stay using Solana or other supported cryptocurrencies, embracing the future of finance."
          />
          <FeatureCard
            icon={<Key className="h-10 w-10 sm:h-12 sm:w-12 text-purple-600 dark:text-purple-400" />}
