      ...
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          <div className="flex items-center justify-center mb-4">
            <Hotel className="h-12 w-12 text-primary" aria-hidden="true" />
          </div>
          <CardTitle className="text-2xl font-bold text-center">Roomie.sol</CardTitle>
          <CardDescription className="text-center">Login to your account using Google</CardDescription>
        </CardHeader>
